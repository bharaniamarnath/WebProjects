...
<div class="jumbotron jumbotron-fluid jumbotron-strip bg-salmon text-white text-center py-4 mb-0">
	<div class="container">
		<h1 class="display-4" id="number-one">Careers</h1>
		<h4>Job at Central Point Pharmacy</h4>
	</div>
</div>
<!-- Jumbotron End -->
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-5 pb-3">
				...
				<h1 class="display-4 text-fuschia">Central Point</h1>
				<p class="lead text-gray">Let us know about you. Fill in your information below and send us.</p>
				<?php if(isset($error)): ?>
					<?php if(!empty($error)): ?>
			...
			<div class="col-lg-7">
				<h1 class="display-4 pb-2">Why Join Us ?</h1>
				<div class="card mb-2">
					<div class="card-block">
						<h2 class="card-title text-gray"><i class="fa fa-compass pr-2"></i>Opportunity</h2>
						<p class="card-text">Get an opportunity to be a part of a standard healthcare organisation and build your future career as a healthcare employee.</p>
					</div>
				</div>
				<div class="card mb-2">
					<div class="card-block">
						<h2 class="card-title text-gray"><i class="fa fa-group pr-2"></i>Teamwork</h2>
						<p class="card-text">Build your career by working together with colleagues by sharing ideas and achieving goals faster.</p>
					</div>
				</div>
				<div class="card">
					<div class="card-block">
						<h2 class="card-title text-gray"><i class="fa fa-graduation-cap pr-2"></i>Learn</h2>
						<p class="card-text">Grab a chance to learn about providing excellent healthcare service through our pharmacy through our well-experienced management.</p>
					</div>
				</div>
			</div>
		</div>
...
<div id="careerModal" class="modal fade">
