...
echo "<div class='row page-title'><div class='col-md-12 col-lg-12'><h2>Dental Instruments</h2><h4>Category does not exist</h4></div></div>";
}
else{
while($ditrow = $getdititle->fetch()){
$dit = str_replace(',','/',$ditrow['classified']);
echo "<div class='row page-title'><div class='col-md-12 col-lg-12'><h2>Dental Instruments</h2><h4>$dit</h4></div></div>";
}
?>
<div class="row order">
<div class="col-md-12 col-lg-12">
<table class="table instruments">
<thead><tr><th class="instrument">Item No.</th>
<th class="instrument">Description</th></tr></thead>
<?php
...
foreach($dins as $dinsrow){
$listdins = utf8_encode($dinsrow['description']);
echo $listdins;
}
?>
</table>
<?php 
echo "<input class='btn btn-danger btn-lg pull-right' type='button' onClick=parent.location='".$BASE_URL."dental-instruments.php' value='Back' />"; 
echo "</div>";
echo "</div>";
} 
?>
