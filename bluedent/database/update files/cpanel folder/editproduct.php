...
$pddesc = stripslashes($rowdet['description']);
$pddimage = $rowdet['image'];
$pddate = $rowdet['date'];
$pdimage = "http://www.bluedentindia.in/images/products/$pdcat/$pdsubcat/thumbs/$pdid.png";
}
}
?>
<form action="http://www.bluedentindia.in/updateproduct.php" method="POST" enctype="multipart/form-data">
<div class="col-md-12"><table class="table edit-box"><thead><tr><th colspan="2">Edit Product</th></tr></thead>
<tr><td>Product Name</td><td><input class="form-control" type="text" name="pname" value="<?php echo $pdname; ?>" /></td></tr>
...
<tr><td colspan="2">Description</td></tr><tr><td colspan="2"><textarea class="form-control" id="description" name="description"><?php echo $pddesc; ?></textarea></td></tr>
<tr><td colspan="2">
<div id="textcontrol">
<?php
$para = "&lt;p&gt;&#92;n&#92;n&lt;&#47;p&gt;";
...
<tr><td colspan="2">Product Image</td></tr><tr><td colspan="2"><img class='img-responsive' src='<?php echo $pdimage; ?>' /></td></tr><tr><td>Update Product Image<br /><i>(Optional)</i><td><span class="btn btn-warning btn-file">Browse Image<input type="file" name="image" id="image" /></span></td></tr>
<tr><td>Date Added</td><td><?php echo $pddate; ?></td></tr>
<tr><td colspan="2"><input type="hidden" value="<?php echo $pdid; ?>" name="prodid" />
<button class="btn btn-success btn-lg pull-right" id="progressButton" disabled="disabled" style="display:none;">Processing...</button>
<button class="btn btn-success btn-lg pull-right" type="submit" name="updateproduct" onclick="this.style.display='none'; document.getElementById('progressButton').style.display='inline';">Update</button><a class="btn btn-danger btn-sm" id="deletelink" role="button" href="http://www.bluedentindia.in/deleteproduct.php?proid=<?php echo $pdid; ?>">Delete</a></td></tr>
</table>
</form>
