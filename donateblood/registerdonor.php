...
$user = $pdo->prepare("SELECT * FROM donors WHERE duname = :Username");
$user->execute(array(
...
$insfeed = $pdo->prepare("INSERT INTO donors (did,duname,dpasswd,dname,dgender,dob,btype,demail,dphone,daddr) VALUES (:cid,:cuname,:cpasswd,:cname,:cgender,:cdob,:cblood,:cemail,:cphone,:caddress)");
...
if($insfeed){
echo "<div class='alert alert-info'>Blood Donor registered successfully</div>";
...
?>
<form id="donorRegistration" action="registerdonor.php" method="POST">
