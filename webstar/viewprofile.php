...
echo "<tr><td id='profilehead'><div id='profileimg'><?php echo '<a href='imageupload.php'><img src='$fimgloc' id='profileimgcrop' /></a></div></td><td id='profilehead'><h2>$fname $lname</h2><br />";
...
<h5>Favorites</h5>
<?php
$getfavs = $pdo->prepare("SELECT * FROM favorites WHERE Username = :Username");
$getfavs->execute(array('Username'=>$fproid));
