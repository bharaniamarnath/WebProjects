...
{
if (isset ($_FILES['myppfile'])){
$imgid = rand(000000,999999);
$imgpath = "publicphotos/$imgid.jpg";
$imagename = $_FILES['myppfile']['name'];
$filename = $_POST['filename'];
$filedesc = $_POST['filedes'];
$source = $_FILES['myppfile']['tmp_name'];
$file_size = $_FILES['myppfile']['size'];
$size_limit = '2000000';
$target = "publicphotos/$imgid.jpg";
$thumb = "publicphotos/thumbs/$imgid.jpg";
$file_type = $_FILES['myppfile']['type'];
...
if($_FILES['myppfile']['type'] == 'image/jpeg'):
move_uploaded_file($source, $target);
elseif($_FILES['myppfile']['type'] == 'image/png'):
move_uploaded_file($source, $target);
elseif($_FILES['myppfile']['type'] == 'image/gif'):
move_uploaded_file($source, $target);
endif;
endif;
...
$imagepath = "$imgid.jpg";
$save = "publicphotos/" . $imagepath; //This is the new file you saving
$file = "publicphotos/" . $imagepath; //This is the original file
$x = @getimagesize($file); 
switch($x[2]) { 
case 1: 
...
$save = "publicphotos/thumbs/" . $imagepath; //This is the new file you saving
$file = "publicphotos/" . $imagepath; //This is the original file
...
<div id="aboutme">
<h3>Upload public photos:</h3><br />
<h4>The photos uploaded here can be viewed by everyone public.</h4><br />
<table class='regform'>
...
<tr><td class='regform'>Upload Photo:</td> <td class='regform'><div id="browsefile"><input type='file' name='myppfile' id='myppfile' accept="image/*" /></div></td></tr>
<tr><td></td><td><input type='submit' name='uploadpp' value='Upload'></form></table>
</div>
</div>
</div>
</div>
