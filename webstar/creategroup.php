...
<tr><td class='regform'>Group Description:</td> <td class='regform'><textarea name='grpdes' id='grpdes'></textarea></td></tr>
<tr><td class='regform'>Upload Photo:</td> <td class='regform'><div id="browsefile"><input type='file' name='myfile' id='myfile' /></div></td></tr>
<tr><td></td><td><input type='submit' name='creategroup' value='Create Group'></form></table>
</div>
</div>
</div>
</div>
