...
<table class="mailbox" style="padding-top: 10px; background: #eee;">
<tr>
<td class="mail">To: </td><td class="mail"><input type="text" name="reciever" /><font style="font-weight:normal; margin-left:5px; font-size: 10px;">Username</font></td>
</tr>
<tr>
<td class="mail">Subject: </td><td class="mail"><input type="text" name="subject" /></td>
</tr>
<tr>
<td class="mail">Message: </td><td class="mail"><textarea id="mailbody" name="mailbody"></textarea><br /><br /></td>
</tr>
