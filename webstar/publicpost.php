...
<div class="messageboard"><form action="bulletin.php" method="POST"><p>Post Message:</p><textarea name="msgpost"></textarea><br /><input type="submit" name="post" value='Post' id="postbutton"></input></form><br /></div>

<div class="videoboard"><form action="bulletin.php" method="POST"><p>Post Youtube Video Link:</p><textarea name="vdopost"></textarea><br /><input type="submit" name="vidpost" value='Post' id="postbutton"></input></form><br /></div>

<div class="imageboard"><form action="postpublicphotos.php" method="POST" method='POST' enctype='multipart/form-data'><p>Post an Image:</p><input type='file' name='myfile' id='myfile' accept="image/*" /><br /><input type='submit' name='upload' value='Upload'></form><br /></div>
...
echo "<input type='submit' name='report' id='postdelete' value='Report'>";
echo "</form>";
}
echo "</div>";
}
