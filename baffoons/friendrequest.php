...
<li class="active"><a href="friendrequest.php"><span class='glyphicon glyphicon-bell'></span> Friend Requests</a></li>
</ul>		
</div>
</div>
...
echo "<div class='row post-message'><div class='col-md-3 col-xs-5'><img class='img-responsive thumbnail' src='$postimgthumb' /></div>";
echo "<div class='col-md-9 col-xs-7'>";
echo "<h5>$ffname $flname</h5>";
echo "<div class='row'>";
echo "<div class='col-md-3'>";
echo "<form action='viewfriend.php' method='POST'>";
echo "<input type='hidden' name='viewpro' value='$fusrid' />";
echo "<input class='btn btn-default btn-sm' type='submit' name='viewprofile' value='View Profile'>";
echo "</form>";
echo "</div>";
echo "<div class='col-md-4'>";
echo "<form action='addfriend.php' method='POST'>";
echo "<input type='hidden' name='addfrnd' value='$fusrid' />";
echo "<input class='btn btn-primary btn-sm' type='submit' name='addfriend' value='Accept Request'>";
echo "</form>";
echo "</div>";
echo "<div class='col-md-3'>";
echo "<form action='deleterequest.php' method='POST'>";
echo "<input type='hidden' name='reqfrnd' value='$fusrid' />";
echo "<input class='btn btn-danger btn-sm' type='submit' name='deleterequest' value='Delete Request'>";
echo "</form>";
echo "</div>";
echo "</div>";
echo "</div>";
...
echo "<div class='row'><div class='col-md-5 col-xs-5'><img class='img-responsive thumbnail' src='$rpimg' /></div>";
...
echo "<input class='btn btn-info btn-xs' type='submit' name='sendreq' value='Add Friend'>";
echo "</form>";
echo "</div>";
echo "</div>";
}
