...
<li class="active"><a href="main.php"><span class='glyphicon glyphicon-th-large'></span> My Board</a></li>
...
<form action="message.php" method="POST" class="form-group"><label for=" ">Post Message:</label><textarea class="form-control" name="msgpost"></textarea><button class="btn btn-success pull-right" type="submit" name="post" id="postbutton">Post</button></form>
</div>

<div class="post-image-box">
<form action="postphotos.php" method='POST' enctype='multipart/form-data' class="form-group"><label for=" ">Post an Image:</label><input type='file' name='myfile' id='myfile' accept="image/*" /><button class="btn btn-success pull-right" type='submit' name='upload'>Post</button></form>
</div>

<div class="post-video-box">
<form action="message.php" method="POST" class="form-group"><label for=" ">Post Youtube Link:</label><textarea class="form-control" name="vdopost"></textarea><button class="btn btn-success pull-right" type="submit" name="vidpost" id="postbutton">Post</button></form>
</div>
...
$postm = stripslashes($msgrow['Message']);
...
echo "<div class='row post-message'><div class='col-md-3 col-xs-4'><img class='img-responsive' src='$uthumbloc' /></div>";
...
echo "</h5>";
echo "<p>".$postm."</p>";
echo "<div class='label label-info pull-left'>$posttime</div><br />";
echo "</div></div>";
}
}
}
...
echo "<a class='btn btn-info btn-sm pull-right' href='friendrequest.php'>View Requests</a>";
}
?>
</div>
</div>
