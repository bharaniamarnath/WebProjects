...
echo "<tr>";
echo "<td class='mail'>To:<br /><input type='text' name='reciever' value='$replyto' /><font color='#309cbc' style='padding-left: 5px; font-size: 11px;'></font></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='mail'>Subject:<br /><input type='text' name='subject' /></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='mail'>Message:<br /><textarea name='mailbody' id='mailbody'></textarea></td>";
echo "</tr>";
echo "<tr>";
echo "<td class='mail'><input type='submit' value='Send Message' name='send' id='sendbutton'' /></td>";
echo "</tr>";
echo "</table>";
}
?>
