...
$photores = $pdo->prepare("SELECT * FROM publicphotos WHERE UserID=:UserID ORDER BY Date DESC LIMIT $start, $perpage");
...
echo "<tr>";
echo "<td colspan='3'>";
echo "<a href='publicphotoview.php?photoid=$phuid'><img src='$phthumb' id='photoimage'></img></a>";
echo "</td>";
echo "</tr>";
echo "<tr>";
echo "<td>";
...
echo "</div>";
?>
</div><input type='button' onClick=parent.location='uploadpublicphotos.php' value='Upload Public Photos' style="margin-bottom: 20px;"></input><input type='button' onClick=parent.location='publicphotos.php' value='Public Photos' style="margin-bottom: 20px;"></input><br />
</div>
</div>
...
$randpp->execute(array('Username'=>$suid));
